				...
				<FormikStepper
					...
					onSubmit={async (values, actions) => {
						const progress = notifications.showNotification({
							...
							message: 'Estamos subiendo tu información a la base de datos. Cuando terminemos en breves, serás redirigido al Dashboard donde puedes controlar tus oficinas',
							autoClose: false,
							disallowClose: true,
						})
